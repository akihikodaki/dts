...
ACTION = "vxlan_encap"
ETHERNET_HEADER = (
    "ethernet_dst_addr N(0xa0a1a2a3{0:04x}) "
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-p", help="number of network ports (default: 4)", required=False, default=4
    )
