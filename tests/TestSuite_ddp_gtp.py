...
class TestDdpGtp(TestCase):
    ...
    def gtp_packets(
        ...
        pkts = []
        pkts_gtpc_pay = {
            "IPV4/GTPC": 'Ether()/IP()/UDP(%sdport=2123)/GTP_U_Header(teid=%s)/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPC": 'Ether()/IPv6()/UDP(%sdport=2123)/GTP_U_Header(teid=%s)/Raw("X"*20)'
            % (chk, teid),
        }

        pkts_gtpu_pay = {
            "IPV4/GTPU": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/Raw("X"*20)'
            % (chk, teid),
        }

        pkts_gtpu_ipv4 = {
            "IPV4/GTPU/IPV4": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV4/FRAG": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP(frag=5)/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV4/UDP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/UDP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV4/TCP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/TCP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV4/SCTP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/SCTP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV4/ICMP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/ICMP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV4": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV4/FRAG": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP(frag=5)/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV4/UDP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/UDP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV4/TCP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/TCP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV4/SCTP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/SCTP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV4/ICMP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IP()/ICMP()/Raw("X"*20)'
            % (chk, teid),
        }

        pkts_gtpu_ipv6 = {
            "IPV4/GTPU/IPV6/FRAG": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/IPv6ExtHdrFragment()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV6": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV6/UDP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/UDP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV6/TCP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/TCP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV6/SCTP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/SCTP()/Raw("X"*20)'
            % (chk, teid),
            "IPV4/GTPU/IPV6/ICMP": 'Ether()/IP()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6(nh=58)/ICMP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV6/FRAG": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/IPv6ExtHdrFragment()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV6": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV6/UDP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/UDP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV6/TCP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/TCP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV6/SCTP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6()/SCTP()/Raw("X"*20)'
            % (chk, teid),
            "IPV6/GTPU/IPV6/ICMP": 'Ether()/IPv6()/UDP(%sdport=2152)/GTP_U_Header(teid=%s)/IPv6(nh=58)/ICMP()/Raw("X"*20)'
            % (chk, teid),
        }
            ...
            for teid_opt in ["correct teid", "wrong teid"]:
                ...
                for chksum_opt in ["good chksum", "bad chksum"]:
                    ...
                    if queue != 0 and type is "fdir":
                        self.verify(
                            count == out.count("RTE_MBUF_F_RX_FDIR"),
    ...
    def test_fdir_gtpu_pf(self):
        ...
        self.gtp_test(type="fdir", port="pf", tunnel_pkt="gtpu", inner_L3="ipv4")
        self.gtp_test(type="fdir", port="pf", tunnel_pkt="gtpu", inner_L3="ipv6")
    ...
    def test_clfter_gtpc_pf(self):
        ...
        """
        self.gtp_test(type="clfter", port="pf", tunnel_pkt="gtpc", inner_L3=None)
    ...
    def test_clfter_gtpu_pf(self):
        ...
        """
        self.gtp_test(type="clfter", port="pf", tunnel_pkt="gtpu", inner_L3=None)
