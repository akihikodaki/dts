...
class TestDPDKGsoLib(TestCase):
    ...
    def start_vm(self, mode=0):
        ...
        if mode == 0:
            vm_params_1[
                "opt_settings"
            ] = "mrg_rxbuf=on,csum=on,gso=on,host_tso4=on,guest_tso4=on,host_ufo=on,guest_ufo=on"
        # no offload
        elif mode == 1:
            vm_params_1[
                "opt_settings"
        ...
        # gre and vxlan
            ...
            vm_params_1[
                "opt_settings"
            ] = "mrg_rxbuf=on,csum=on,guest_csum=on,gso=on,host_tso4=on,guest_tso4=on,guest_ecn=on"
