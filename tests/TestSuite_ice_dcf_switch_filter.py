...
tv_mac_pay = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(src="00:00:00:00:00:02",dst="00:11:22:33:44:55")/IP()/Raw("x" *80)',
...
tv_mac_ipv4_pay = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="68:05:ca:8d:ed:a3")/IP(src="192.168.0.1",dst="192.168.0.2",tos=4,ttl=2)/TCP()/("X"*480)',
...
tv_mac_ipv4_udp_pay = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="68:05:ca:8d:ed:a3")/IP(src="192.168.0.1",dst="192.168.0.2",tos=4,ttl=3)/UDP(sport=25,dport=23)/("X"*480)',
...
tv_mac_ipv4_tcp_pay = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="68:05:ca:8d:ed:a3")/IP(src="192.168.0.1",dst="192.168.0.2",tos=4,ttl=3)/TCP(sport=25,dport=23)/("X"*480)',
...
tv_mac_ipv4_igmp = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:55")/IP()/TCP()/Raw("X"*480)',
...
tv_mac_ipv6_srcip_dstip = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:55")/IPv6(src="CDCD:910A:2222:5498:8475:1111:3900:1537", dst="CDCD:910A:2222:5498:8475:1111:3900:2020")/("X"*480)',
...
tv_mac_ipv6_dstip_tc = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="68:05:ca:8d:ed:a3")/IPv6(src="CDCD:910A:2222:5498:8475:1111:3900:1518", dst="CDCD:910A:2222:5498:8475:1111:3900:2020",tc=3)/("X"*480)',
...
tv_mac_ipv6_udp_pay = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="68:05:ca:8d:ed:a3")/IPv6(src="CDCD:910A:2222:5498:8475:1111:3900:1518", dst="CDCD:910A:2222:5498:8475:1111:3900:2020",tc=3)/UDP(sport=25,dport=23)/("X"*480)',
...
tv_mac_ipv6_tcp = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="68:05:ca:8d:ed:a3")/IPv6(src="CDCD:910A:2222:5498:8475:1111:3900:1518", dst="CDCD:910A:2222:5498:8475:1111:3900:2020",tc=3)/TCP(sport=25,dport=23)/("X"*480)',
...
tv_udp_port_filter_dhcp_discovery = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:55")/IP()/UDP(sport=63,dport=67)/BOOTP(chaddr="3c:fd:fe:b2:43:90")/DHCP(options=[("message-type","discover"),"end"])/Raw("X"*480)',
...
tv_udp_port_filter_dhcp_offer = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:55")/IP()/UDP(sport=63,dport=68)/BOOTP(chaddr="3c:fd:fe:b2:43:90",yiaddr="192.168.1.0")/DHCP(options=[("message-type","offer"),"end"])/Raw("X"*480)',
...
tv_udp_port_filter_vxlan = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether()/IP(dst="192.168.0.1")/NVGRE(TNI=2)/Ether()/IP(src="192.168.1.2", dst="192.168.1.3")/TCP()/Raw("x"*80)'
        ],
        "check_func": {
            "func": rfc.check_vf_rx_packets_number,
            "param": {"expect_port": [0, 3], "expect_queues": "null"},
...
tv_mac_vlan_filter = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:54",type=0x8100)/Dot1Q(vlan=1)/IP(src="192.168.0.1",dst="192.168.0.2",tos=4,ttl=2)/TCP()/Raw("X"*480)',
...
tv_mac_ipv4_l2tpv3 = {
    ...
    "mismatched": {
        "scapy_str": [
            "Ether(dst='00:11:22:33:44:12')/IP(src='192.168.0.2', proto=115)/L2TP(b'\\x00\\x00\\x00\\x02')/('X'*480)",
...
tv_mac_ipv6_l2tpv3 = {
    ...
    "mismatched": {
        "scapy_str": [
            "Ether(dst='00:11:22:33:44:13')/IPv6(dst='1111:2222:3333:4444:5555:6666:7777:8888', nh=115)/L2TP(b'\\x00\\x00\\x00\\x02')/('X'*480)",
...
tv_mac_ipv4_esp = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:22")/IP(src="192.168.0.2", proto=50)/ESP(spi=2)/("X"*480)',
...
tv_mac_ipv6_esp = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:13")/IPv6(dst="1111:2222:3333:4444:5555:6666:7777:8888", nh=50)/ESP(spi=2)/("X"*480)',
...
tv_mac_ipv4_ah = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:13")/IP(src="192.168.0.2", proto=51)/AH(spi=2)/("X"*480)',
...
tv_mac_ipv6_ah = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:13")/IPv6(dst="1111:2222:3333:4444:5555:6666:7777:8888", nh=51)/AH(spi=2)/("X"*480)',
...
tv_mac_ipv4_nat_t_esp = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:13")/IP(src="192.168.0.2")/UDP(dport=4500)/ESP(spi=2)/("X"*480)',
...
tv_mac_ipv6_nat_t_esp = {
    ...
    "mismatched": {
        "scapy_str": [
            'Ether(dst="00:11:22:33:44:13")/IPv6(dst="1111:2222:3333:4444:5555:6666:7777:8888")/UDP(dport=4500)/ESP(spi=2)/("X"*480)',
...
tv_mac_ipv4_pfcp_session = {
    ...
    "rte_flow_pattern": [
        ...
        "flow create 0 ingress pattern eth / ipv4 / udp / pfcp s_field is 1 / end actions port_representor port_id 0 / end",
    ],
    "matched": {
...
tv_mac_ipv4_udp_l4_mask_in_single_vf_01 = {
    ...
    "rte_flow_pattern": "flow create 0 priority 0 ingress pattern eth / ipv4 / udp src spec 2152 src mask 0xff00 dst spec 1281 dst mask 0x00ff / end actions represented_port ethdev_port_id 1 / end",
    "matched": {
...
tv_mac_ipv6_tcp_l4_mask_in_single_vf_02 = {
    ...
    "rte_flow_pattern": "flow create 0 priority 0 ingress pattern eth / ipv6 / tcp dst spec 3333 dst mask 0x0ff0 / end actions represented_port ethdev_port_id 1 / end",
    "matched": {
...
tv_mac_ipv4_udp_vxlan_eth_ipv4_udp_l4_mask_in_single_vf_03 = {
    ...
    "rte_flow_pattern": "flow create 0 priority 0 ingress pattern eth / ipv4 / udp / vxlan / eth / ipv4 / udp src spec 32 src mask 0x0f / end actions represented_port ethdev_port_id 1 / end",
    "matched": {
...
tv_mac_ipv4_nvgre_eth_ipv4_udp_l4_mask_in_single_vf_04 = {
    ...
    "rte_flow_pattern": "flow create 0 ingress pattern eth / ipv4 dst is 192.168.0.1 / nvgre tni is 0x8 / eth / ipv4 src is 192.168.0.2 dst is 192.168.0.3 / udp src spec 1280 src mask 0x00ff / end actions represented_port ethdev_port_id 1 / end",
    "matched": {
...
mac_ipv4_tcp_l4_mask_scapy_str = {
    "matched": ['Ether(dst="%s")/IP()/TCP(sport=2313,dport=23)/Raw("x"*80)' % vf1_mac],
    "mismatched": [
...
class ICEDCFSwitchFilterTest(TestCase):
    ...
    def set_up_all(self):
        ...
        self.testpmd_status_did_rebuild = False
        # bind pf to kernel
    ...
    def test_max_vfs(self):
        ...
        self.dut.build_install_dpdk(self.target, extra_options="-Dmax_ethports=256")
        self.testpmd_status_did_rebuild = True
        # launch testpmd
        vf0_pci = vf_pci[0]
        all_eal_param = self.dut.create_eal_parameters(
            cores="1S/4C/1T",
            ports=[vf0_pci],
            port_options={vf0_pci: f"cap=dcf,representor=[1-{max_vf_number-1}]"},
        )
        command = self.path + all_eal_param + " -- -i"
        out = self.dut.send_expect(command, "testpmd> ", 30)
        self.testpmd_status = "running"
    ...
    def tear_down(self):
        ...
        self.dut.kill_all()
        if self.testpmd_status_did_rebuild:
