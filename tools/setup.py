...
def load_execution(file_name):
    ...
    suites = [suite.strip() for suite in config.get(section, "test_suites").split(",")]
...
def config_execution():
    ...
    exec_option = {
        ...
        "type": "choice",
        "help": "Gernerate execution file base on default or " + "manually configured",
        "options": ["default execution file", "manually configure execution file"],
        "default": "0",
    }
...
def config_ixia():
    ...
    ixiaport_option = {
        ...
        "type": "string",
        "help": "Please input IXIA ports, format is " + "card1.port1,card2.port2",
        "default": "",
    }
...
def main():
    ...
    while not config_done:
        config_option = {
            "prompt": "Choose preparation steps for running dts",
            "type": "choice",
